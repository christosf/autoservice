            ...
            <q-td :props='props' class='q-px-xl' auto-width>
              ...
              >
                ...
                <q-tooltip anchor='top middle' self='bottom middle'>
                  {{ props.value ? $t('core.active') : $t('core.inactive') }}
                </q-tooltip>
              </div>
            </q-td>
          </template>
            ...
            <q-td :props='props'>
              <q-chip
                ...
                :style='{
                  ...
                  color: brightness(props.row.color) < 128 ? "white" : "black"
                }'
                square
              />
            </q-td>
...
export default {
  setup() {
    ...
    const contactTags = computed(() => (
      contactSettings.value && contactSettings.value.contactTags
        ? contactSettings.value.contactTags
        : []
    ))
