                ...
                <q-card bordered flat>
                    ...
                    <q-card-section class='q-pa-none'>
                        ...
                        >
                            ...
                            <q-item-section>
                                <q-item-label class='text-body1'>{{ vehicle.owner.name }}</q-item-label>
                                <q-item-label class='text-body2 text-grey-6 q-pt-xs'>{{ vehicle.owner.phoneNumber }}</q-item-label>
                            </q-item-section>
                        </q-item>
                    </q-card-section>
                </q-card>
